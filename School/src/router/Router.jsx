...
import AdmissionNotificationManagement from "../pages/Admin/AdmissionNotificationManagement";
...
const router = createBrowserRouter([
  {
    ...
    children: [
     ...
     {path: "/work", element: <Homework/>},
     {path: "/contact", element: <Contact/>},
     {path: "/Amissionstructure", element: <Amissionstructure/>},
     {path: "/admin-login", element: <AdminLogin/>},
     {path: "/admin-dashboard", element: <AdminDashboard/>},
     {path: "/admin-notice", element: <NoticeManagement/>},
     {path: "/admin/events", element: <EventManagement/>},
     {path: "/admin/admission", element: <AdmissionNotificationManagement/>},
     {path: "/admin/gallery", element: <GalleryManagement/>},
     {path: "/admin/homework", element: <HomeworkManagement/>}
