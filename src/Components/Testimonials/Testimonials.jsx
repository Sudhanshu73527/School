...
const testimonials = [
  {
    ...
    role: "Parent",
    feedback:
      "This school has transformed my child’s learning experience. Highly recommended!",
  ...
  },
  {
    ...
    role: "Student",
    feedback:
      "The extra-curricular activities are awesome! I’ve learned so many new skills here.",
  ...
  return (
    <section className="bg-gray-50 py-12">
      <div className="max-w-6xl mx-auto px-4 text-center">
        <h2 className="text-3xl md:text-5xl font-bold text-[#2E1C14] mb-8">
          What Our <span className="text-yellow-400">Students & Parents</span> Say
        </h2>
